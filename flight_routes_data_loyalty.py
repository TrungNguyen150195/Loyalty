...
# Define constants
HOOK_MSSQL_AMELIA_DB = 'mssql_amelia_db'
HOOK_S3_G1_DATA_LAKE = 's3_vj_data_airflow'
...
def flight_routes_data_loyalty():
    ...
    def extract_from_sql_server(trans_date_str: str) -> Dict[str, str]:
        ...
        file_name = f"Flight_Routes_"+prefix_name+'.csv'
        ...
        query = f'dbVietjet_Data_Collection.dbo.rp_Loyalty_Flight_Route'

        # log the query to console
        print("Query rp_Loyalty_Flight_Route:"+query)
...
dag = flight_routes_data_loyalty()
