...
def flight_data_loyalty():
    ...
    def extract_from_sql_server(trans_date_str: str) -> Dict[str, str]:
        ...
        file_name = f"Flight_"+prefix_name+'.csv'
        ...
        query = f'dbVietjet_Data_Collection.dbo.rp_Loyalty_Flight'

        # log the query to console
        print("Query rp_Loyalty_Flight:"+query)
